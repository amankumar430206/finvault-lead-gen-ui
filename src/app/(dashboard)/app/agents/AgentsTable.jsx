        ...
        <div className="fade-up mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-primary/75 text-sm mt-0.5">{filtered.length} records · last updated just now</p>
            </div>
          ...
          {/* <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
            {[
              ...
              <div key={s.label} className="bg-card2 border  border-[var(--border-clr)] rounded-xl px-4 py-3">
                <p className="text-primary/75 text-[11px] uppercase tracking-wider font-medium mb-1">{s.label}</p>
          ...
          >
            ...
            <div className="px-6 py-6 border-b  border-[var(--border-clr)]">
              <div className="flex justify-between">
                <p className="text-primary/75 text-xs uppercase tracking-wider mb-1">{detailRow?.role} </p>
              ...
              <div className="rounded-xl border  border-[var(--border-clr)] bg-inputbg divide-y divide-white/[0.04] overflow-hidden">
                {[
                  ...
                  <div key={k} className="flex items-center justify-between px-4 py-3">
                    <span className="text-primary/75 text-sm capitalize">{k}</span>
                ...
                {detailRow?.passport?.verified ? (
                  <>
                    <div className="flex items-center justify-between px-4 py-3 bg-accent/10">
                      <span className="text-primary/75 text-sm capitalize">Verfication Status</span>
