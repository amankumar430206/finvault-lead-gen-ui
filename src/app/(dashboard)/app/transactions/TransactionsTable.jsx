          ...
          <div className="px-5 py-4 border-b  border-[var(--border-clr)]">
            ...
            {filtersOpen && (
              <div className="mt-3 pt-3 border-t  border-[var(--border-clr)] flex flex-col gap-3">
                <div>
                  <p className="text-primary/70 text-[10px] uppercase tracking-widest mb-2">Currency</p>
                      ...
                      >
                        ...
                        <td className="px-4 py-3.5">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-primary/85 font-medium text-sm leading-tight">{tx.transactionId}</p>
                              <p className="text-primary/50 text-xs mt-0.5 mono">{tx.referenceId}</p>
                            </div>
                          </div>
                        </td>
                        {/* Date */}
                        <td className="px-4 py-3.5">
                          <p className="text-primary/55 text-sm">{fmtTimeStampDate(tx.createdAt)}</p>
                        </td>
                        {/* remitter */}
                        <td className="px-4 py-3.5">
                        ...
                        <td className="px-4 py-3.5">
                          <span className="text-xs font-medium mono text-primary/40 px-2 py-1 rounded-md">
                            {tx.vendor}
                          </span>
                        </td>
                        {/* Amount */}
                        <td className="px-4 py-3.5 text-right">
                          <p className={`font-semibold text-sm mono text-accent`}>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-primary/85 font-medium text-sm truncate">{tx.transactionId}</p>
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="text-primary/50 text-xs mono">{tx.referenceId}</span>
                      </div>
                    </div>
                    <div className="text-right shrink-0">
                      <p className={`font-semibold text-sm mono text-accent`}>{fmtAmount(tx.amount, tx.currency)}</p>
                      <p className="text-primary/70 text-xs">{fmtTimeStampDate(tx.createdAt)}</p>
                    </div>
                  </div>
                );
              })
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b  border-[var(--border-clr)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-primary font-semibold text-sm">{detailRow.transactionId} </p>
                </div>
              </div>
            ...
            <div className="px-6 py-6 border-b  border-[var(--border-clr)]">
              ...
              <p className={`text-3xl font-bold mono text-accent`}>{fmtAmount(detailRow.amount, detailRow.currency)}</p>
            ...
            <div className="flex-1 px-6 py-4 space-y-5 overflow-y-auto">
              <h1 className="text-primary text-sm mb-3">Transaction Details</h1>
              ...
              {/* Fee Config */}
              <h1 className="text-primary text-sm mb-3">Fee Structure</h1>
              <div className="rounded-xl border  border-[var(--border-clr)] bg-inputbg divide-y divide-white/[0.04] overflow-hidden">
                {[
